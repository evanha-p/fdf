...
/*   Updated: 2022/10/05 17:30:05 by evanha-p         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	errors(char *str)
{
	...
	{
		ft_putstr_fd("file content invalid. Submit a file with only numbers and spaces", 2);
		ft_putstr_fd(" or hexadecimal color value separated by , after the height\n", 2);
	}
